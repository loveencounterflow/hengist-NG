...
@nfa_tasks =
  ...
  #---------------------------------------------------------------------------------------------------------
  accepts_callable_rejects_others: ->
    ...
    do =>
      ...
      @throws ( Ωnfat__51 = -> nfa null                               ), /expected a callable/
      @eq     ( Ωnfat__52 = -> type_of nfa ( a, b, cfg ) -> 40        ), 'function'
      @eq     ( Ωnfat__53 = -> type_of nfa ( a, b, cfg ) -> await 40  ), 'function'
      @eq     ( Ωnfat__54 = -> type_of nfa ( a, b, cfg ) -> yield 40  ), 'function'
      return null
    #.......................................................................................................
    do =>
      gf = nfa ( a, cfg ) -> yield cfg.a; yield cfg.a + 1; return null
      @eq     ( Ωnfat__55 = -> [ ( gf 4 )..., ]  ), [ 4, 5, ]
    #.......................................................................................................
    return null
  ...
  names_in_cfg_are_created: ->
    ...
    do =>
      ...
      frz = Object.freeze
      #.....................................................................................................
      @eq     ( Ωnfat__56 = -> fn()                                       ), { first_name: undefined, last_name: undefined,   }
      @eq     ( Ωnfat__57 = -> fn 'Alice'                                 ), { first_name: 'Alice',   last_name: undefined,   }
      @eq     ( Ωnfat__58 = -> fn 'Alice', 'McMillan'                     ), { first_name: 'Alice',   last_name: 'McMillan',  }
      @eq     ( Ωnfat__59 = -> fn                      {}                 ), { first_name: undefined, last_name: undefined,   }
      @eq     ( Ωnfat__60 = -> fn 'Alice',             {}                 ), { first_name: 'Alice',   last_name: undefined,   }
      @eq     ( Ωnfat__61 = -> fn 'Alice', 'McMillan', {}                 ), { first_name: 'Alice',   last_name: 'McMillan',  }
      @eq     ( Ωnfat__62 = -> fn                      { city: 'Seoul', } ), { first_name: undefined, last_name: undefined,  city: 'Seoul', }
      @eq     ( Ωnfat__63 = -> fn 'Alice',             { city: 'Seoul', } ), { first_name: 'Alice',   last_name: undefined,  city: 'Seoul', }
      @eq     ( Ωnfat__64 = -> fn 'Alice', 'McMillan', { city: 'Seoul', } ), { first_name: 'Alice',   last_name: 'McMillan', city: 'Seoul', }
      #.....................................................................................................
      return null
    #.......................................................................................................
    return null
  ...
  get_signature: ->
    ...
    do =>
      ...
      ```
      @eq     ( Ωnfat__65 = -> get_signature ( a, cfg             ) ->  ), { names: [ 'a', 'cfg' ], q_idx: 1, q_ridx: -1, }
      @throws ( Ωnfat__66 = -> get_signature ( a = optional, cfg  ) ->  ), /not compliant/
      @throws ( Ωnfat__67 = -> get_signature ( a                  ) ->  ), /not compliant/
      @eq     ( Ωnfat__68 = -> get_signature empty_fn                   ), { names: [ 'cfg' ], q_idx: 0, q_ridx: -1, }
      @eq     ( Ωnfat__69 = -> get_signature ( cfg )                ->  ), { names: [ 'cfg' ], q_idx: 0, q_ridx: -1, }
      @eq     ( Ωnfat__70 = -> get_signature ( a, b, c, cfg       ) ->  ), { names: [ 'a', 'b', 'c', 'cfg' ], q_idx: 3, q_ridx: -1, }
      ...
      @throws ( Ωnfat__72 = -> get_signature ( a, b..., c, cfg    ) ->  ), /not compliant/
      @throws ( Ωnfat__73 = -> get_signature ( a, b = null, cfg   ) ->  ), /not compliant/
      return null
    #.......................................................................................................
    do =>
      @throws ( Ωnfat__74 = -> get_signature ( a, b, cfg, c,      g ) ->  ), /not compliant/
      @eq     ( Ωnfat__75 = -> get_signature ( a, b,      c, cfg, g ) ->  ), { names: [ 'a', 'b', 'c', 'cfg', 'g', ], q_idx: 3, q_ridx: -2, }
      return null
    #.......................................................................................................
    return null
  ...
  template_class: ->
    ...
    #.......................................................................................................
    do =>
      @eq     ( Ωnfat__76 = -> new Template { arc: 10, bo: 11, cy: 12, din: 13; eps: 14, foo: 15, } ), { arc: 10, bo: 11, cy: 12, din: 13; eps: 14, foo: 15, }
    #.......................................................................................................
    do =>
      mylist_1      = []
      mylist_2      = []
      ...
      @eq     ( Ωnfat__77 = -> t ), { mylist_1: [], mylist_2: [], mylist_3: [], }
      @eq     ( Ωnfat__78 = -> t.mylist_1   is    mylist_1  ), true
      @eq     ( Ωnfat__79 = -> t.mylist_2   is    mylist_2  ), true
      @eq     ( Ωnfat__80 = -> t.mylist_1   isnt  mylist_2  ), true
      @eq     ( Ωnfat__81 = -> t.mylist_31  isnt  mylist_32 ), true
      mylist_1.push 'A'
      mylist_2.push 'B'
      mylist_31.push 'C'
      @eq     ( Ωnfat__82 = -> t ), { mylist_1: [ 'A', ], mylist_2: [ 'B', ], mylist_3: [], }
      return null
    #.......................................................................................................
    do =>
      cfg =
      ...
      @eq     ( Ωnfat__83 = -> t_1                        ), { name: { first: 'John', last: 'Doe', }, }
      @eq     ( Ωnfat__84 = -> t_1.name isnt cfg.name     ), true
      @eq     ( Ωnfat__85 = -> t_1                        ), { name: { first: 'John', last: 'Doe', }, }
      @eq     ( Ωnfat__86 = -> t_2.name isnt cfg.name     ), true
      @eq     ( Ωnfat__87 = -> t_1.name isnt t_2.name     ), true
      return null
    #.......................................................................................................
    return null
  ...
  template_setting: ->
    ...
    do =>
      ...
      @eq     ( Ωnfat__93 = -> fn 20, 21, 22, {} ), { arc: 20, bo: 21, cy: 22, cfg: { arc: 20, bo: 21, cy: 22, }, }
      @eq     ( Ωnfat__94 = -> fn()              ), { arc: 10, bo: 11, cy: 12, cfg: { arc: 10, bo: 11, cy: 12, }, }
      @eq     ( Ωnfat__95 = -> fn 20             ), { arc: 20, bo: 11, cy: 12, cfg: { arc: 20, bo: 11, cy: 12, }, }
      @eq     ( Ωnfat__96 = -> fn 20, 21         ), { arc: 20, bo: 21, cy: 12, cfg: { arc: 20, bo: 21, cy: 12, }, }
  ...
  cfg_in_penultimate_position: ->
    ...
    do =>
      ...
      @eq     ( Ωnfat__98 = -> fn()                         ), { name: null,      cfg: { name: null    } }
      @eq     ( Ωnfat__99 = -> fn 'alice', { name: 'bob', } ), { name: 'alice',   cfg: { name: 'alice' } }
      return null
    #.......................................................................................................
    do =>
      template =
      ...
      @eq     ( Ωnfat_100 = -> fn()                             ), { name: 'carl',  f: undefined, cfg: { name: 'carl',  f: undefined, }, }
      @eq     ( Ωnfat_101 = -> fn          { name: 'bob', },  F ), { name: 'bob',   f: F,         cfg: { name: 'bob',   f: F,         }, }
      @eq     ( Ωnfat_102 = -> fn 'alice', { name: 'bob', },  F ), { name: 'alice', f: F,         cfg: { name: 'alice', f: F,         }, }
      @eq     ( Ωnfat_103 = -> fn 'alice', {              },  F ), { name: 'alice', f: F,         cfg: { name: 'alice', f: F,         }, }
      @eq     ( Ωnfat_104 = -> fn 'alice',                    F ), { name: 'alice', f: F,         cfg: { name: 'alice', f: F,         }, }
      @eq     ( Ωnfat_105 = -> fn                             F ), { name: 'carl',  f: F,         cfg: { name: 'carl',  f: F,         }, }
      return null
    #.......................................................................................................
    return null
  ...
  function_naming: ->
    ...
    do =>
      my_fn = ( cfg ) ->
      @eq     ( Ωnfat_106 = ->       my_fn.name   ), 'my_fn'
      @eq     ( Ωnfat_107 = -> ( nfa my_fn ).name ), 'my_fn'
      return null
    #.......................................................................................................
    return null
      ...
      ts =
        quantity:
          ...
          isa: ( x ) ->
            ...
            return true
      fn = nfa ts.quantity, quantity_create = ( q, u, cfg ) -> cfg
      @eq     ( Ωnfat_115 = ->  fn 3, 's'                     ), { q: 3, u: 's', }
      @eq     ( Ωnfat_116 = ->  fn 3, 's', { q: 0, u: 'u', }  ), { q: 3, u: 's', }
      @throws ( Ωnfat_117 = ->  fn 3, ''                      ), /validation error: expected a quantity_create_cfg/
      return null
    #.......................................................................................................
    return null
