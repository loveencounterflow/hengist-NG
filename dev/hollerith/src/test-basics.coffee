...
@hollerith =
  ...
  h10mvp_3: ->
    ...
    { isDeepStrictEqual: equals, } = require 'node:util'
    #.......................................................................................................
    @eq     ( Ωanybt__66 = -> hollerith_10mvp.encode_idx -999   ), hollerith_10mvp.encode [ -999, ]
    @eq     ( Ωanybt__67 = -> hollerith_10mvp.encode_idx  -99   ), hollerith_10mvp.encode [  -99, ]
    @eq     ( Ωanybt__68 = -> hollerith_10mvp.encode_idx  -90   ), hollerith_10mvp.encode [  -90, ]
    @eq     ( Ωanybt__69 = -> hollerith_10mvp.encode_idx  -11   ), hollerith_10mvp.encode [  -11, ]
    @eq     ( Ωanybt__70 = -> hollerith_10mvp.encode_idx  -10   ), hollerith_10mvp.encode [  -10, ]
    @eq     ( Ωanybt__71 = -> hollerith_10mvp.encode_idx   -9   ), hollerith_10mvp.encode [   -9, ]
    @eq     ( Ωanybt__72 = -> hollerith_10mvp.encode_idx   -8   ), hollerith_10mvp.encode [   -8, ]
    @eq     ( Ωanybt__73 = -> hollerith_10mvp.encode_idx   -7   ), hollerith_10mvp.encode [   -7, ]
    @eq     ( Ωanybt__74 = -> hollerith_10mvp.encode_idx   -6   ), hollerith_10mvp.encode [   -6, ]
    @eq     ( Ωanybt__75 = -> hollerith_10mvp.encode_idx   -5   ), hollerith_10mvp.encode [   -5, ]
    @eq     ( Ωanybt__76 = -> hollerith_10mvp.encode_idx   -4   ), hollerith_10mvp.encode [   -4, ]
    @eq     ( Ωanybt__77 = -> hollerith_10mvp.encode_idx   -3   ), hollerith_10mvp.encode [   -3, ]
    @eq     ( Ωanybt__78 = -> hollerith_10mvp.encode_idx   -2   ), hollerith_10mvp.encode [   -2, ]
    @eq     ( Ωanybt__79 = -> hollerith_10mvp.encode_idx   -1   ), hollerith_10mvp.encode [   -1, ]
    @eq     ( Ωanybt__80 = -> hollerith_10mvp.encode_idx    0   ), hollerith_10mvp.encode [    0, ]
    @eq     ( Ωanybt__81 = -> hollerith_10mvp.encode_idx    1   ), hollerith_10mvp.encode [    1, ]
    @eq     ( Ωanybt__82 = -> hollerith_10mvp.encode_idx   +9   ), hollerith_10mvp.encode [   +9, ]
    @eq     ( Ωanybt__83 = -> hollerith_10mvp.encode_idx  +10   ), hollerith_10mvp.encode [  +10, ]
    @eq     ( Ωanybt__84 = -> hollerith_10mvp.encode_idx  +20   ), hollerith_10mvp.encode [  +20, ]
    @eq     ( Ωanybt__85 = -> hollerith_10mvp.encode_idx  +90   ), hollerith_10mvp.encode [  +90, ]
    @eq     ( Ωanybt__86 = -> hollerith_10mvp.encode_idx  123   ), hollerith_10mvp.encode [  123, ]
    @eq     ( Ωanybt__87 = -> hollerith_10mvp.encode_idx +900   ), hollerith_10mvp.encode [ +900, ]
    return null
  ...
  h10mvp_sorting_2: ->
    ...
    for _ in [ 1 .. 10 ]
      ...
      @eq ( Ωhllt__91 = -> equals expected_indexes, real_indexes ), false
    #.......................................................................................................
    for _ in [ 1 .. 10 ]
  ...
  h128_16383_sorting_2: ->
    ...
    for _ in [ 1 .. 10 ]
      ...
      for uline in unpadded_lines
        ...
        real_indexes.push Number uline.replace /^.*?\s([0-9]+)$/, '$1'
      @eq ( Ωhllt_161 = -> equals expected_indexes, real_indexes ), false
    #.......................................................................................................
    for _ in [ 1 .. 10 ]
 ...
 #      'Ç!ÆÆÆÆÆ¿;ãããããããããããããããããããããããããããããããããããã'
  ...
  can_set_max_idx_digits: ->
    ...
    do =>
      ...
      @eq ( Ωhllt_377 = -> cfg._min_integer               ), -999
      @eq ( Ωhllt_378 = -> cfg._max_integer               ), +999
      @eq ( Ωhllt_379 = -> cfg.digits_per_idx             ), 3
      #.....................................................................................................
      h = new Hollerith user_cfg
      @eq ( Ωhllt_380 = -> h.cfg                          ), cfg
      @eq ( Ωhllt_381 = -> h.encode [ 0, ]                ), 'NNNNNNNNNNNNNNNNNNNN'
      return null
    #.......................................................................................................
    do =>
      user_cfg =
        ...
        _max_integer:       999
      { cfg, } = Hollerith.validate_and_compile_cfg user_cfg
      @eq ( Ωhllt_382 = -> cfg._min_integer               ), -999
      @eq ( Ωhllt_383 = -> cfg._max_integer               ), +999
      @eq ( Ωhllt_384 = -> cfg.digits_per_idx             ), 3
      #.....................................................................................................
      h = new Hollerith user_cfg
      @eq ( Ωhllt_385 = -> h.cfg                          ), cfg
      @eq ( Ωhllt_386 = -> h.encode [ 0, ]                ), 'NNNNNNNNNNNNNNNNNNNN'
      return null
    #.......................................................................................................
    do =>
      user_cfg =
        ...
        digits_per_idx:    3
      { cfg, } = Hollerith.validate_and_compile_cfg user_cfg
      @eq ( Ωhllt_387 = -> cfg._min_integer               ), -999
      @eq ( Ωhllt_388 = -> cfg._max_integer               ), +999
      @eq ( Ωhllt_389 = -> cfg.digits_per_idx             ), 3
      #.....................................................................................................
      h = new Hollerith user_cfg
      @eq ( Ωhllt_390 = -> h.cfg                          ), cfg
      @eq ( Ωhllt_391 = -> h.encode [ 0, ]                ), 'NNNNNNNNNNNNNNNNNNNN'
      return null
    #=======================================================================================================
    do =>
      user_cfg =
      ...
      { cfg, } = Hollerith.validate_and_compile_cfg user_cfg
      @eq ( Ωhllt_392 = -> cfg._min_integer               ), -99_999
      @eq ( Ωhllt_393 = -> cfg._max_integer               ), +99_999
      @eq ( Ωhllt_394 = -> cfg.digits_per_idx             ), 5
      #.....................................................................................................
      h = new Hollerith user_cfg
      @eq ( Ωhllt_395 = -> h.cfg                          ), cfg
      @eq ( Ωhllt_396 = -> h.encode [ 0, ]                ), 'NNNNNNNNNNNNNNNNNNNNNNNNNNNNNN'
      return null
    #.......................................................................................................
    do =>
      user_cfg =
        ...
        _max_integer:       999
      { cfg, } = Hollerith.validate_and_compile_cfg user_cfg
      @eq ( Ωhllt_397 = -> cfg._min_integer               ), -99_999
      @eq ( Ωhllt_398 = -> cfg._max_integer               ), +99_999
      @eq ( Ωhllt_399 = -> cfg.digits_per_idx             ), 5
      #.....................................................................................................
      h = new Hollerith user_cfg
      @eq ( Ωhllt_400 = -> h.cfg                          ), cfg
      @eq ( Ωhllt_401 = -> h.encode [ 0, ]                ), 'NNNNNNNNNNNNNNNNNNNNNNNNNNNNNN'
      return null
    #.......................................................................................................
    do =>
      user_cfg =
        ...
        digits_per_idx:     3
      { cfg, } = Hollerith.validate_and_compile_cfg user_cfg
      @eq ( Ωhllt_402 = -> cfg._min_integer               ), -999
      @eq ( Ωhllt_403 = -> cfg._max_integer               ), +999
      @eq ( Ωhllt_404 = -> cfg.digits_per_idx             ), 3
      #.....................................................................................................
      h = new Hollerith user_cfg
      @eq ( Ωhllt_405 = -> h.cfg                          ), cfg
      @eq ( Ωhllt_406 = -> h.encode [ 0, ]                ), 'NNNNNNNNNNNNNNNNNNNN'
      return null
    #.......................................................................................................
    return null
  ...
  types: ->
    ...
    do =>
      T = new Hollerith_typespace()
      @eq     ( Ωhllt_407 = -> T._base.isa -1                                                        ), false
      @eq     ( Ωhllt_408 = -> T._base.isa  0                                                        ), false
      @eq     ( Ωhllt_409 = -> T._base.isa +1                                                        ), false
      @eq     ( Ωhllt_410 = -> T._base.isa +2                                                        ), true
      @eq     ( Ωhllt_411 = -> T._max_integer.isa null                                            ), false
      @eq     ( Ωhllt_412 = -> T._max_integer.isa 9,          10                                  ), true
      @eq     ( Ωhllt_413 = -> T._max_integer.isa 99,         10                                  ), true
      @eq     ( Ωhllt_414 = -> T._max_integer.isa 99999999,   10                                  ), true
      @eq     ( Ωhllt_415 = -> T._max_integer.isa -10,        10                                  ), false
      @eq     ( Ωhllt_416 = -> /not a positive safe integer/.test T._max_integer.data.message     ), true
      @eq     ( Ωhllt_417 = -> T._max_integer.isa 0xffff,     16                                  ), true
      @eq     ( Ωhllt_418 = -> T._max_integer.isa 0x7fffffff, 16                                  ), false
      @throws ( Ωhllt_419 = -> T._max_integer.validate 5, 10                                      ), /\(_max_integer_\$\) not a valid _max_integer_\$: 5 – x not a positive all-niners/
      return null
    #.......................................................................................................
    do =>
      T = new Hollerith_typespace()
      R = { _base: 16, digits_per_idx: 4, }
      @eq     ( Ωhllt_420 = -> T._max_integer.isa ( R._base ** R.digits_per_idx ) - 1, R._base ), true
      return null
    #.......................................................................................................
    do =>
      T = new Hollerith_typespace()
      @eq     ( Ωhllt_421 = -> T._max_integer.isa ( 128 ** 1 ) - 1, 128             ), true
      @eq     ( Ωhllt_422 = -> T._max_integer.isa ( 128 ** 2 ) - 1, 128             ), true
      @eq     ( Ωhllt_423 = -> T._max_integer.isa ( 128 ** 3 ) - 1, 128             ), true
      @eq     ( Ωhllt_424 = -> T._max_integer.isa ( 128 ** 4 ) - 1, 128             ), true
      @eq     ( Ωhllt_425 = -> T._max_integer.isa ( 128 ** 5 ) - 1, 128             ), true
      @eq     ( Ωhllt_426 = -> T._max_integer.isa ( 128 ** 6 ) - 1, 128             ), true
      @eq     ( Ωhllt_427 = -> T._max_integer.isa ( 128 ** 7 ) - 1, 128             ), true
      @eq     ( Ωhllt_428 = -> T._max_integer.isa ( 128 ** 8 ) - 1, 128             ), false
      @eq     ( Ωhllt_429 = -> T.create_max_integer { _base: 10, digits_per_idx: 2, } ), 99
      return null
    #.......................................................................................................
    return null
