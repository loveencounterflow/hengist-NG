...
@hollerith =
  ...
  h128_16383_sorting_2: ->
    ...
    @eq ( Ωhllt_106 = -> codec.cfg.nmag_chrs[ 2 ]                           ), 'Í'
    ...
    @eq ( Ωhllt_119 = -> codec.cfg.pmag_chrs[ codec.cfg._max_digits_per_idx ] ), 'ù'
  ...
  types: ->
    ...
    @eq ( Ωhllt_249 = -> Object.isFrozen T.magnifiers.data.pmag_chrs          ), true
  ...
  validate_and_compile_cfg_10: ->
    ...
    do =>
      ...
      @eq ( Ωhllt_289 = -> cfg.nmag_chrs                                          ), Array.from ' CBA'
      @eq ( Ωhllt_290 = -> cfg.pmag_chrs                                          ), Array.from ' XYZ'
  ...
  validate_and_compile_cfg_10_no_unilterals: ->
    ...
    do =>
      ...
      @eq ( Ωhllt_333 = -> cfg.nmag_chrs                                          ), Array.from ' CBA'
      @eq ( Ωhllt_334 = -> cfg.pmag_chrs                                          ), Array.from ' XYZ'
  ...
  validate_and_compile_cfg_128: ->
    ...
    do =>
      ...
      @eq ( Ωhllt_357 = -> cfg.nmag_chrs                                          ), Array.from ' ÎÍÌËÊÉÈÇ'
      @eq ( Ωhllt_358 = -> cfg.pmag_chrs                                          ), Array.from ' øùúûüýþÿ'
