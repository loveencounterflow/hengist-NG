...
facet_value           json );`
  ...
  on conflict ( facet_key ) do update set facet_value = excluded.facet_value;`,
    ...
    //---------------------------------------------------------------------------------------------------------
    integer_storage_with_infinity: function() {
      var Dbric_store, row, rows, store, Ωbbdbr_114, Ωbbdbr_115, Ωbbdbr_116, Ωbbdbr_117;
      Dbric_store = (function() {
        //=======================================================================================================
        class Dbric_store extends Dbric {};
  ...
  ( abs( n ) = 9e999 ) or (
    ...
    and ( n <= ${Number.MAX_SAFE_INTEGER} ) ) )
        ...
        Dbric_store.statements = {
          ...
          select_numbers: SQL`select * from numbers order by n;`
        };
      ...
      //=======================================================================================================
      store = Dbric_store.rebuild(':memory:');
      store.statements.insert_number.run({
        n: 9
      });
      store.statements.insert_number.run({
        n: 4.0
      ...
      this.throws((Ωbbdbr_114 = function() {
        return store.statements.insert_number.run({
          n: 4.5
        });
      }), /check constraint failed/i);
      this.throws((Ωbbdbr_115 = function() {
        return store.statements.insert_number.run({
          n: Number.MAX_SAFE_INTEGER + 1e5
        });
      }), /check constraint failed/i);
      ...
      for (row of rows = store.walk(store.statements.select_numbers)) {
        echo(row);
      }
      rows = store.walk(store.statements.select_numbers);
...
order by n;`
      ...
      (() => {        //=======================================================================================================
        var db_path, i, n, rows, squares, Ωbbdbr_119, Ωbbdbr_120, Ωbbdbr_121, Ωbbdbr_122, Ωbbdbr_123, Ωbbdbr_124, Ωbbdbr_125, Ωbbdbr_126, Ωbbdbr_127, Ωbbdbr_128, Ωbbdbr_129;
        db_path = '/dev/shm/bricabrac.sqlite';
        ...
        //.....................................................................................................
        // echo 'Ωbbdbr_118', row for row from squares.statements.select_from_squares.iterate()
...
order by n;`
        ...
        Dbric_squares.aggregate_functions = {
          product: {
            ...
            step: product = function(total, element) {
              // debug 'Ωbbdbr_130', { total, element, }
      ...
      (() => {        //=======================================================================================================
        var db_path, i, n, rows, squares, Ωbbdbr_132, Ωbbdbr_133, Ωbbdbr_135;
        ...
        //.....................................................................................................
        // echo 'Ωbbdbr_131', row for row from squares.statements.select_from_squares.iterate { start: 1, stop: 5, }
        rows = squares.statements.select_from_squares.iterate({
          start: 1,
          stop: 5
        });
        ...
        this.throws((Ωbbdbr_135 = function() {
          return squares.statements.select_from_squares.iterate();
        }), /missing named parameters/i);
        // @eq ( Ωbbdbr_136 = -> rows.next().value ), { n: null, square: null, p_n: 1, p_square: 1 }
        // @eq ( Ωbbdbr_137 = -> rows.next().value ), null
        //.....................................................................................................
        return null;
      })();
      //.......................................................................................................
...
order by n;`
      ...
      (() => {        //=======================================================================================================
        var db_path, i, n, rows, squares, Ωbbdbr_138, Ωbbdbr_139, Ωbbdbr_140, Ωbbdbr_141, Ωbbdbr_142, Ωbbdbr_143, Ωbbdbr_144, Ωbbdbr_145, Ωbbdbr_146, Ωbbdbr_147, Ωbbdbr_148;
        db_path = '/dev/shm/bricabrac.sqlite';
        squares = Dbric_squares.rebuild(db_path);
        for (n = i = 0; i < 10; n = ++i) {
          squares.statements.insert_number.run({n});
...
order by n;`
      ...
      (() => {        //=======================================================================================================
        var i, n, rows, squares, Ωbbdbr_151, Ωbbdbr_152;
        squares = Dbric_squares.rebuild();
        for (n = i = 0; i < 10; n = ++i) {
          squares.statements.insert_number.run({n});
        }
        //.....................................................................................................
        // echo 'Ωbbdbr_150', row for row from squares.statements.select_from_squares.iterate { start: 2, stop: 3, }
        rows = squares.statements.select_from_squares.iterate({
          start: 2,
          stop: 3
        });
...
on conflict ( phrase ) do nothing;`,
  ...
  order by p.phrase;`
      ...
      (() => {        //=======================================================================================================
        var i, len, phrase, phrases, ref, rows, Ωbbdbr_155, Ωbbdbr_156, Ωbbdbr_157, Ωbbdbr_158, Ωbbdbr_159, Ωbbdbr_160, Ωbbdbr_161, Ωbbdbr_162, Ωbbdbr_163, Ωbbdbr_164, Ωbbdbr_165, Ωbbdbr_166, Ωbbdbr_167;
        ...
        //.....................................................................................................
        // echo 'Ωbbdbr_153', row for row from phrases.statements.select_from_phrases.iterate { matcher: '^.*([aeiou].e).*$', }
        // echo()
        //.....................................................................................................
        // echo 'Ωbbdbr_154', row for row from phrases.statements.select_from_phrases.iterate { matcher: '([^aeiou]?[aeiou]+)(?=[mnv])', }
...
on conflict ( dskey, line_nr, keyword ) do nothing;`,
      ...
      (() => {        //=======================================================================================================
        var dskey, i, j, keyword, keywords, len, len1, line, line_nr, phrases, rows, Ωbbdbr_168, Ωbbdbr_169;
        phrases = Dbric_phrases.rebuild();
        ...
        //.....................................................................................................
        // echo 'Ωbbdbr_170', row for row from phrases.statements.select_from_datasources.iterate()
        // echo()
        // #...................................................................................................
        // echo 'Ωbbdbr_171', row for row from phrases.statements.select_from_mirror.iterate()
        // echo()
        //.....................................................................................................
...
// debug 'Ωbbdbr_172', line_nr, rpr keywords
        ...
        // #...................................................................................................
        // echo 'Ωbbdbr_173', row for row from phrases.statements.select_from_keywords.iterate()
        // echo()
        //.....................................................................................................
        return null;
      })();
        ...
        Dbric_phrases.table_functions = {
          split_words: {
            ...
            rows: function*(line) {
              ...
              keywords = line.split(/(?:\p{Z}+)|((?:\p{L}+)|(?:\p{N}+)|(?:\p{S}+))/v);
// debug 'Ωbbdbr_174', line_nr, rpr keywords
      ...
      (() => {        //=======================================================================================================
        var db_path, phrases, rows, Ωbbdbr_177, Ωbbdbr_178, Ωbbdbr_180, Ωbbdbr_181, Ωbbdbr_182, Ωbbdbr_184, Ωbbdbr_185, Ωbbdbr_186, Ωbbdbr_187, Ωbbdbr_188, Ωbbdbr_189, Ωbbdbr_190, Ωbbdbr_191, Ωbbdbr_192, Ωbbdbr_193, Ωbbdbr_194;
        db_path = '/dev/shm/bricabrac.sqlite';
        phrases = Dbric_phrases.rebuild(db_path);
        // debug 'Ωbbdbr_175', phrases.teardown()
        // debug 'Ωbbdbr_176', phrases.rebuild()
        ...
        //.....................................................................................................
        // echo 'Ωbbdbr_179', row for row from phrases.statements.locations_from_keyword.iterate { keyword: 'thought', }
        // echo()
        ...
        //.....................................................................................................
        // echo 'Ωbbdbr_183', row for row from phrases.statements.locations_from_keyword.iterate { keyword: 'she', }
        // echo()
        rows = phrases.statements.locations_from_keyword.iterate({
          keyword: 'she'
        });
    ...
    dbric_std_variables_and_sequences: function() {
      var cfg_do_show_variables, db, freeze, lets, rows, variables, Ωbbdbr_195, Ωbbdbr_196, Ωbbdbr_198, Ωbbdbr_210, Ωbbdbr_228, Ωbbdbr_230, Ωbbdbr_231, Ωbbdbr_232, Ωbbdbr_233, Ωbbdbr_234, Ωbbdbr_235, Ωbbdbr_236;
      ...
      this.throws((Ωbbdbr_196 = function() {
        return db.std_set_variable('myname', 'myvalue');
      }), /illegal to set variable/);
      // @throws ( Ωbbdbr_197 = -> db.std_get_variable 'myname'                            ), /illegal to get variable/
      ...
      db.std_with_variables(() => {
        var Ωbbdbr_199, Ωbbdbr_200, Ωbbdbr_201, Ωbbdbr_202, Ωbbdbr_203, Ωbbdbr_204, Ωbbdbr_205, Ωbbdbr_206;
        this.throws((Ωbbdbr_199 = function() {
          return db.std_get_variable('myname');
        }), /unknown variable/);
      ...
      db.std_with_variables({
        ...
        var Ωbbdbr_207, Ωbbdbr_209;
        this.eq((Ωbbdbr_207 = function() {
          return db.std_get_variable('name');
        }), 'Alice');
        // debug 'Ωbbdbr_208', { name, job, }
      ...
      //.......................................................................................................
      db.std_with_variables(() => {
        var rows, Ωbbdbr_214, Ωbbdbr_215, Ωbbdbr_216;
...
-- primary key ( rowid )
constraint "Ωconstraint_212" check ( length( letter ) = 1 )
) strict;`);
...
;`);
        ...
        // info 'Ωbbdbr_213', row for row from db.walk SQL"select * from letters;"
      ...
      //.......................................................................................................
      db.std_with_variables(() => {
        var rows, Ωbbdbr_218, Ωbbdbr_219, Ωbbdbr_220;
...
;`);
        ...
        // info 'Ωbbdbr_217', row for row from db.walk SQL"select * from numbers;"
      ...
      (() => {        //.......................................................................................................
        var insert_letter, rows, Ωbbdbr_221, Ωbbdbr_222, Ωbbdbr_223;
...
select
  ...
  where letter between std_get_variable( 'first_letter' ) and std_get_variable( 'last_letter' );`);
        ...
        return db.std_with_variables({
          ...
          var result, row, Ωbbdbr_224, Ωbbdbr_225, Ωbbdbr_226;
          result = ((function() {
            var results;
            results = [];
  ...
  de        text          not null,
primary key ( rowid ),
constraint "Ωconstraint_227" check ( rowid regexp 't:wrd:R=\\d+' ) );`);
...
$de );`);
      ...
      // echo 'Ωbbdbr_229', row for row from db.walk SQL"select * from prfx_words order by de;"
    ...
    dbric_strict_mode: function() {
      ...
      (() => {        //.......................................................................................................
        ...
        // debug 'Ωbbdbr_237', ( row.f for row from db.walk SQL"select f from t;" )
        return null;
      })();
      (() => {        //.......................................................................................................
        var db, Ωbbdbr_238, Ωbbdbr_239, Ωbbdbr_240, Ωbbdbr_241, Ωbbdbr_242, Ωbbdbr_243;
        db = Dbric.rebuild(':memory:');
        (db.prepare(SQL`pragma strict       = on;`)).run();
        ...
        this.throws((Ωbbdbr_243 = function() {
          return db.execute(SQL`insert into t ( f ) values ( 'wat' );`);
        }), /cannot store TEXT value in INTEGER column/);
        // debug 'Ωbbdbr_244', ( row.f for row from db.walk SQL"select f from t;" )
        return null;
      })();
      //.......................................................................................................
      return null;
    ...
    dbric_dynamic_build_properties: function() {
      (() => {        //.......................................................................................................
        var Db_1, db, relation_names, row, rows, Ωbbdbr_248, Ωbbdbr_249, Ωbbdbr_250, Ωbbdbr_251, Ωbbdbr_252, Ωbbdbr_253, Ωbbdbr_254;
        Db_1 = (function() {
        ...
        debug('Ωbbdbr_245', relation_names);
        debug('Ωbbdbr_246', db.constructor.prefix);
        debug('Ωbbdbr_247', db.cfg);
    ...
    dbric_plugins_acquisition: function() {
      var Db_1, contributions, contributor, db, function_names, get_all_in_prototype_chain, get_prototype_chain, i, j, len, len1, nbr_number_plugin, other_plugin, r, ref, ref1, ref2, ref3, ref4, result, table_names, text_plugin, type, type_of, Ωbbdbr_255, Ωbbdbr_258, Ωbbdbr_267, Ωbbdbr_268, Ωbbdbr_269, Ωbbdbr_270, Ωbbdbr_271, Ωbbdbr_272, Ωbbdbr_273, Ωbbdbr_274, Ωbbdbr_275, Ωbbdbr_276;
      ...
      for (j = 0, len1 = ref2.length; j < len1; j++) {
        ...
        if (type === 'plugin') {
          info('Ωbbdbr_256', `[${type}]${(ref3 = contributor.name) != null ? ref3 : '(anonymous)'}`, Object.keys(contributor.exports));
        } else {
          ((contributor === db.constructor) ? help : urge)('Ωbbdbr_257', `[${type}]${(ref4 = contributor.name) != null ? ref4 : '(anonymous)'}`);
        }
      }
      //=======================================================================================================
      ...
      debug('Ωbbdbr_259', toggle('build:               ', Object.keys(contributions.build)));
      debug('Ωbbdbr_260', toggle('aggregate_functions: ', Object.keys(contributions.aggregate_functions)));
      debug('Ωbbdbr_261', toggle('functions:           ', Object.keys(contributions.functions)));
      debug('Ωbbdbr_262', toggle('methods:             ', Object.keys(contributions.methods)));
      debug('Ωbbdbr_263', toggle('statements:          ', Object.keys(contributions.statements)));
      debug('Ωbbdbr_264', toggle('table_functions:     ', Object.keys(contributions.table_functions)));
      debug('Ωbbdbr_265', toggle('virtual_tables:      ', Object.keys(contributions.virtual_tables)));
      debug('Ωbbdbr_266', toggle('window_functions:    ', Object.keys(contributions.window_functions)));
      //-------------------------------------------------------------------------------------------------------
  ...
  demo_using_methods_holder_to_enable_ersatz_super = function() {
    ...
    A = class A {
      f(message) {
        return help('Ωbbdbr_277', rpr(message));
      }
    ...
    info('Ωbbdbr_278', {result}); // prints `{ result: 8, }`
    //---------------------------------------------------------------------------------------------------------
    return null;
  };
  ...
  if (module === require.main) {
    await (() => {
      ...
      (new Test(guytest_cfg)).test({
        integer_storage_with_infinity: tests.integer_storage_with_infinity
      });
      //---------------------------------------------------------------------------------------------------------
      if (do_coverage) {
        if (ca.unused_names.length > 0) {
          ...
          for (i = 0, len = ref.length; i < len; i++) {
            name = ref[i];
            warn('Ωbbdbr_280', "not covered:", reverse(name));
          }
        }
      }
      // help 'Ωbbdbr_281', ca.used_names
      // urge 'Ωbbdbr_282', count, names for count, names of ca.names_by_counts
      //=========================================================================================================
      return null;
    })();
  }
...
//# sourceMappingURL=data:application/json;base64,
