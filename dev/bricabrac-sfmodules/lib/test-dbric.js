...
$de );`);
    ...
    dbric_hoard_plugin_model: function() {
      var Hoard, Hoard_extras, Hoard_user, ascii, h, hoard_plugin, names, row, rows, run, runs, summarize_data, u, Ωbbdbr_278, Ωbbdbr_279, Ωbbdbr_280, Ωbbdbr_281, Ωbbdbr_282, Ωbbdbr_283, Ωbbdbr_284, Ωbbdbr_285, Ωbbdbr_286, Ωbbdbr_287, Ωbbdbr_288, Ωbbdbr_289, Ωbbdbr_290, Ωbbdbr_291, Ωbbdbr_292, Ωbbdbr_293;
...
values ( $rowid, $lo, $hi, $scatter );`
      ...
      this.eq((Ωbbdbr_292 = function() {
        return h.summarize_data_for_point('&');
      }), null);
  ...
  demo_using_methods_holder_to_enable_ersatz_super = function() {
    ...
    A = class A {
      f(message) {
        return help('Ωbbdbr_306', rpr(message));
      }
    ...
    await (() => {
      ...
      if (do_coverage) {
        if (ca.unused_names.length > 0) {
          ...
          for (i = 0, len = ref.length; i < len; i++) {
            name = ref[i];
            warn('Ωbbdbr_309', "not covered:", reverse(name));
          }
        }
      }
