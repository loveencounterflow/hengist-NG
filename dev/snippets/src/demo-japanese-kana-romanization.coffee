...
demo_pkg_wanakana = ->
  ...
  help 'Ωdjkr___7', toRomaji    'つじぎりょ',    { customRomajiMapping: { じ: '(zi)', つ: '(tu)', り: '(li)', りょう: '(ryou)', りょ: '(ryo)' }, }
  help 'Ωdjkr___8', toRomaji    'つじぎりょう',   { customRomajiMapping: { じ: '(zi)', つ: '(tu)', り: '(li)', りょう: '(ryou)', りょ: '(ryo)' }, }
  help 'Ωdjkr___9', toRomaji    'つじぎりょう',   { customRomajiMapping: { じ: '(zi)', つ: '(tu)', り: '(li)', }, }
  help 'Ωdjkr__10', toKatakana    'つじぎりょう',   { customKanaMapping: { つじ: '(辻1)', ツジ: '(辻2)', }, }
  help 'Ωdjkr__11', tokenize    'つじぎりょう', { detailed: true, }
  help 'Ωdjkr__12', tokenize    'つじラーメン', { detailed: true, }
  help 'Ωdjkr__13', toKatakana    'ぎり,ラーメン,𪜈',   { customKanaMapping: { 𪜈: '(とも)', つじ: '(辻1)', ツジ: '(辻2)', }, }
  help 'Ωdjkr__14', toHiragana    'ぎり,ラーメン,𪜈',   { customKanaMapping: { 𪜈: '(とも)', つじ: '(辻1)', ツジ: '(辻2)', }, }
