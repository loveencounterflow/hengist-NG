...
* 'infinitely' expandable (within boundaries given by datatype), stably-ordered VNRs
...
* fields:
  ...
  * `data`: arbitrary data, stands in for whatever fields are needed; here special values:
    * (SOD): always represents Start Of Document with nr1 set to constant `000`
    * (EOD): always represents End Of Document with nr1 set to constant `999`
