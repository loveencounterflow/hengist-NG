(async function() {
  ...
  * syntax for a **Type Checker**
   ...
   */
  'use strict';
  var GTNG, GUY, SFMODULES, Test, alert, all_tests, blue, bold, debug, demo_proxy_as_html_producer, echo, f, gold, green, grey, help, info, inspect, log, nfa, plain, praise, red, require_raw, reverse, rpr, tests, tests_for_doublestack_infiniproxy, urge, warn, whisper, white;
  ...
  tests = {
    ...
    test_doublestack_infiniproxy: function() {
      ...
      ({is_tagfun_call, get_first_argument} = SFMODULES.require_tagfun_tools());
